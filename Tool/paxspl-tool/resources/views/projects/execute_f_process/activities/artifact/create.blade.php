...
<form action="{{ route('projects.execute_f_process.activities.artifact.store', ['project'=>$project -> id,'execute_f_process'=>$execute_f_process -> id,'activity'=>$activity -> id,'io'=>$io]) }}" method="POST">
    @csrf
    <div class="row">
        @if ($io=='o')
