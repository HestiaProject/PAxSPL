...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Scoping Process: {{ $scoping_process->name }}</h2>
        </div>
...
<form action="{{ route('projects.scoping_process.update', ['project'=>$project->id,'scoping_process'=>$scoping_process->id,'bpmn'=>'1', ]) }}" method="POST">
    @csrf
    @method('PUT')
...
<script>
    ...
    function save_svg() {
        bpmnModeler.saveSVG({
            ...
            var fileName = '<?php echo $scoping_process->name ?>.svg';
