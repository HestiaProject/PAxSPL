...
<form action="{{ route('projects.execute_s_process.activities.artifact.update', ['project'=>$project -> id,'execute_s_process'=>$execute_s_process -> id,'activity'=>$activity -> id,'artifact'=>$artifact -> id]) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
