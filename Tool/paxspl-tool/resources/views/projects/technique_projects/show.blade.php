...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
        <a class="btn btn-primary" href="{{ route('projects.technique.store', ['project'=>$project->id,'technique'=>$technique->id]) }}">Add to Project <i class="fas fa-plus"></i></a>
        <a class="btn btn-danger" href="{{ route('projects.technique.index', ['project'=>$project->id]) }}">Cancel <i class="fas fa-arrow-left"></i></a>
    </div>
</div>
